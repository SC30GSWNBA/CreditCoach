...
Aravind then asks, "What's my current utilization?" CreditCoach calls an **account-summary tool** and reports what it found: $1,180 of $1,500 on one credit card (79%), $220 of $2,000 on the other (11%), $95 of $500 on a retail card (19%), and 37.4% overall. It explains why the first card is the one to focus on. It computes these figures from the data rather than estimating them. If the tool is unavailable, CreditCoach says it cannot pull the latest figures right now and shares the last figures it confirmed, labeled with when they were confirmed.
...
We will not optimize for breadth of topics. Mortgages, business credit, and non-US scoring systems are out of scope. Our library and evals focus on the first-time borrower's core questions.
...
**Synthetic data that is too thin or too elaborate.** With one profile, the evals would only prove that CreditCoach works for Aravind. With dozens, we would spend Week 1 building data instead of the product. The team has agreed on four to six synthetic profiles, each with several months of score and account history, built in Task #6 by extending the USR-001 sample. Together they cover a utilization spike, a hard inquiry, a 30+ day late payment, a steady improver, and a thin-file user. That is enough variety to show that answers change with the data and are not memorized.
...
|---|---|---|---|
| ACC-01 (credit card) | $1,180 | $1,500 | 79% |
| ACC-02 (credit card) | $220 | $2,000 | 11% |
| ACC-05 (retail card) | $95 | $500 | 19% |
| **Total revolving** | **$1,495** | **$4,000** | **37.4%** |
| ACC-03 (student loan) | $8,400 | — | not revolving |
| ACC-04 (auto loan) | $6,100 | — | not revolving |
